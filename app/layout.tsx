...
// Clash Display (Fontshare), self-hosted: loading it from Fontshare's CDN
// meant a render-blocking stylesheet on another host before first paint.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    // Favicons come from the file conventions in app/: favicon.ico, icon.png
    // and apple-icon.png (the camera mark from the logo).
  };
}
...
export default async function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${jetbrainsMono.variable} ${cormorant.variable} ${playfair.variable} ${pinyon.variable} ${jost.variable} ${clashDisplay.variable}`}>
      <head>
        <script
